...
dependencies {
    ...
    api(LibraryDependency.LIFECYCLE_LIVADATA)
    ...
    //弹出框
    implementation(LibraryDependency.material_dialogs_core)
    implementation(LibraryDependency.material_dialogs_bottomsheets)
    implementation(LibraryDependency.material_dialogs_input)
    implementation(LibraryDependency.material_dialogs_lifecycle)

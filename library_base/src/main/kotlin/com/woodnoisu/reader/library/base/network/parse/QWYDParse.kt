...
class QWYDParse(htmlService: HtmlService):
     ...
     * 根据关键字搜索
     */
    override suspend fun getSearchByKeyword(keyword: String, page: Int): ResponsePage {
     ...
     * 根据类型搜索
     */
    override  suspend fun getSearchByType(typeName:String,page: Int): ResponsePage {

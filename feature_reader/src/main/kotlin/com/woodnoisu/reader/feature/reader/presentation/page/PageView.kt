...
import com.woodnoisu.reader.feature.reader.presentation.page.anim.*
import com.woodnoisu.reader.feature.reader.presentation.page.event.OnCurPageChangeListener
import com.woodnoisu.reader.feature.reader.presentation.page.model.Direction
 ...
 * 绘制页面显示内容的类
 */
internal class PageView @JvmOverloads constructor(
    context: Context?,
    ...
    //点击监听
    private var mOnTouchListener: com.woodnoisu.reader.feature.reader.presentation.page.event.OnTouchListener? = null
     ...
     * 获取 PageLoader
     */
    fun getPageLoader(collBook: ReaderBookDomainModel): PageLoader {
        // 判是否已经存在
        if (mPageLoader != null) {
            return mPageLoader!!
        }
     ...
     * 设置触摸事件
     */
    fun setTouchListener(mOnTouchListener: com.woodnoisu.reader.feature.reader.presentation.page.event.OnTouchListener?) {

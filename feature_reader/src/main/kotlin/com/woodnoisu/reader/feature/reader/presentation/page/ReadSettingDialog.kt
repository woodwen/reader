...
import com.woodnoisu.reader.feature.reader.presentation.page.adapter.PageStyleAdapter
...
import com.woodnoisu.reader.library.base.utils.ScreenUtil
import kotlinx.android.synthetic.main.layout_setting.*

/**
 * 阅读设置对话框
 */
internal class ReadSettingDialog(mActivity: Activity,
                        private var mPageLoader: PageLoader) :

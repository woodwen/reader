...
object LibraryDependency {
    ...
    const val material_dialogs_core =
        "com.afollestad.material-dialogs:core:${LibraryVersion.material_dialogs}"
    const val material_dialogs_bottomsheets =
        "com.afollestad.material-dialogs:bottomsheets:${LibraryVersion.material_dialogs}"
    const val material_dialogs_input =
        "com.afollestad.material-dialogs:input:${LibraryVersion.material_dialogs}"
    const val material_dialogs_lifecycle =
        "com.afollestad.material-dialogs:lifecycle:${LibraryVersion.material_dialogs}"

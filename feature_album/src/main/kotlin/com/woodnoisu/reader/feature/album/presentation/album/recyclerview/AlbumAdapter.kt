...
internal class AlbumAdapter: RecyclerView.Adapter<AlbumAdapter.ViewHolder>() {
    ...
    //列表容器
    private val mList: MutableList<AlbumBookDomainModel> =ArrayList()
    ...
    interface OnBookItemClickListener {
         ...
         * 打开事件
         */
        fun openItem(t: AlbumBookDomainModel)
    }
     ...
     * 添加项目
     */
    fun addItem(value: AlbumBookDomainModel) {
        mList.add(value)
     ...
     * 添加指定位置的项目
     */
    fun addItem(index: Int, value: AlbumBookDomainModel) {
     ...
     * 批量添加项目
     */
    fun addItems(values: List<AlbumBookDomainModel>) {
        mList.addAll(values)
        notifyDataSetChanged()
    }
     ...
     * 移除项目
     */
    fun removeItem(value: AlbumBookDomainModel) {
        mList.remove(value)
        notifyDataSetChanged()
    }
     ...
     * 刷新容器
     */
    fun refreshItems(list: List<AlbumBookDomainModel>) {
        mList.clear()
        mList.addAll(list)
        notifyDataSetChanged()
    }
